...
export default function Booked() {
  ...
  return (
    <div className="flex flex-col h-full">
      <div
        id="header"
        className="md:text-xl flex items-center text-center text-lg font-bold border-b p-2"
      >
        <ChevronsRight
      ...
      <div className="flex-1 overflow-y-auto">
        <div
          className={`grid gap-2 p-2 md:p-4 ${
            state === "collapsed"
        ...
        >
          {bookedTrips.map((trip: Thread) => (
            <Card key={trip.id} className="overflow-hidden rounded-md">
