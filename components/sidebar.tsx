...
import { ChevronsLeft, Home, Ticket, Trash } from "lucide-react";
                ...
                return (
                  <div key={index}>
                    <button
                      ...
                      className={`flex items-center justify-between px-2 w-full text-sm text-center py-2 px-4 hover:bg-sidebar-accent transition rounded-md ${
